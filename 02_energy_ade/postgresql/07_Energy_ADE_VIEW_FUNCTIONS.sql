...
---------------------------------------------------------------
-- Function INSERT_ELECTRICITY_EXCHANGER
---------------------------------------------------------------
CREATE OR REPLACE FUNCTION citydb_view.nrg8_insert_electricity_exchanger(
  id                     integer DEFAULT NULL,
  gmlid                  varchar(256) DEFAULT NULL,
  gmlid_codespace        varchar(1000) DEFAULT NULL,
  name                   varchar(1000) DEFAULT NULL,
...
--
  network_id         integer DEFAULT NULL,
  network_node_id    integer DEFAULT NULL,
  prim_electricity_supplier varchar DEFAULT NULL,
--
  schema_name varchar DEFAULT 'citydb'::varchar
)
RETURNS integer AS
...
--
  p_network_id         integer := network_id        ;
  p_network_node_id    integer := network_node_id   ;
  p_prim_electricity_supplier varchar := prim_electricity_supplier;
--
  p_schema_name varchar := schema_name;
	class_name varchar DEFAULT 'ElectricityExchanger'::varchar;
	db_prefix varchar DEFAULT 'nrg8';
	objectclass_id integer;
	inserted_id integer;
BEGIN
...
PERFORM citydb_pkg.nrg8_insert_electricity_exchanger(
    id                      :=inserted_id,
    objectclass_id          :=objectclass_id,
    network_id              :=p_network_id,
    network_node_id         :=p_network_node_id,
    prim_electricity_supplier:=p_prim_electricity_supplier,
    schema_name             :=p_schema_name
);
RETURN inserted_id;
EXCEPTION
	WHEN OTHERS THEN RAISE NOTICE 'citydb_view.nrg8_insert_electricity_exchanger(): %', SQLERRM;
END;
$BODY$
LANGUAGE plpgsql VOLATILE;

---------------------------------------------------------------
-- Function INSERT_GAS_EXCHANGER
---------------------------------------------------------------
CREATE OR REPLACE FUNCTION citydb_view.nrg8_insert_gas_exchanger(
  id                     integer DEFAULT NULL,
  gmlid                  varchar(256) DEFAULT NULL,
  gmlid_codespace        varchar(1000) DEFAULT NULL,
  name                   varchar(1000) DEFAULT NULL,
...
--
  network_id         integer DEFAULT NULL,
  network_node_id    integer DEFAULT NULL,
  prim_gas_supplier varchar DEFAULT NULL,
--
  schema_name varchar DEFAULT 'citydb'::varchar
)
RETURNS integer AS
...
--
  p_network_id         integer := network_id        ;
  p_network_node_id    integer := network_node_id   ;
  p_prim_gas_supplier varchar := prim_gas_supplier;
--
  p_schema_name varchar := schema_name;
	class_name varchar DEFAULT 'GasExchanger'::varchar;
	db_prefix varchar DEFAULT 'nrg8';
	objectclass_id integer;
	inserted_id integer;
BEGIN
...
PERFORM citydb_pkg.nrg8_insert_gas_exchanger(
    id                      :=inserted_id,
    objectclass_id          :=objectclass_id,
    network_id              :=p_network_id,
    network_node_id         :=p_network_node_id,
    prim_gas_supplier:=p_prim_gas_supplier,
    schema_name             :=p_schema_name
);
RETURN inserted_id;
EXCEPTION
	WHEN OTHERS THEN RAISE NOTICE 'citydb_view.nrg8_insert_gas_exchanger(): %', SQLERRM;
END;
$BODY$
LANGUAGE plpgsql VOLATILE;

---------------------------------------------------------------
-- Function INSERT_OIL_EXCHANGER
---------------------------------------------------------------
CREATE OR REPLACE FUNCTION citydb_view.nrg8_insert_oil_exchanger(
  id                     integer DEFAULT NULL,
  gmlid                  varchar(256) DEFAULT NULL,
  gmlid_codespace        varchar(1000) DEFAULT NULL,
  name                   varchar(1000) DEFAULT NULL,
...
--
  network_id         integer DEFAULT NULL,
  network_node_id    integer DEFAULT NULL,
  prim_oil_supplier varchar DEFAULT NULL,
--
  schema_name varchar DEFAULT 'citydb'::varchar
)
RETURNS integer AS
...
--
  p_network_id         integer := network_id        ;
  p_network_node_id    integer := network_node_id   ;
  p_prim_oil_supplier varchar := prim_oil_supplier;
--
  p_schema_name varchar := schema_name;
	class_name varchar DEFAULT 'OilExchanger'::varchar;
	db_prefix varchar DEFAULT 'nrg8';
	objectclass_id integer;
	inserted_id integer;
BEGIN
...
PERFORM citydb_pkg.nrg8_insert_oil_exchanger(
    id                      :=inserted_id,
    objectclass_id          :=objectclass_id,
    network_id              :=p_network_id,
    network_node_id         :=p_network_node_id,
    prim_oil_supplier:=p_prim_oil_supplier,
    schema_name             :=p_schema_name
);
RETURN inserted_id;
EXCEPTION
	WHEN OTHERS THEN RAISE NOTICE 'citydb_view.nrg8_insert_oil_exchanger(): %', SQLERRM;
END;
$BODY$
LANGUAGE plpgsql VOLATILE;

---------------------------------------------------------------
-- Function INSERT_WOOD_PELLETS_EXCHANGER
---------------------------------------------------------------
CREATE OR REPLACE FUNCTION citydb_view.nrg8_insert_wood_pellets_exchanger(
  id                     integer DEFAULT NULL,
  gmlid                  varchar(256) DEFAULT NULL,
  gmlid_codespace        varchar(1000) DEFAULT NULL,
  name                   varchar(1000) DEFAULT NULL,
...
--
  network_id         integer DEFAULT NULL,
  network_node_id    integer DEFAULT NULL,
  prim_wood_supplier varchar DEFAULT NULL,
--
  schema_name varchar DEFAULT 'citydb'::varchar
)
RETURNS integer AS
...
--
  p_network_id         integer := network_id        ;
  p_network_node_id    integer := network_node_id   ;
  p_prim_wood_supplier varchar := prim_wood_supplier;
--
  p_schema_name varchar := schema_name;
	class_name varchar DEFAULT 'WoodPelletsExchanger'::varchar;
	db_prefix varchar DEFAULT 'nrg8';
	objectclass_id integer;
	inserted_id integer;
BEGIN
...
PERFORM citydb_pkg.nrg8_insert_wood_pellets_exchanger(
    id                      :=inserted_id,
    objectclass_id          :=objectclass_id,
    network_id              :=p_network_id,
    network_node_id         :=p_network_node_id,
    prim_wood_supplier:=p_prim_wood_supplier,
    schema_name             :=p_schema_name
);
RETURN inserted_id;
EXCEPTION
	WHEN OTHERS THEN RAISE NOTICE 'citydb_view.nrg8_insert_wood_pellets_exchanger(): %', SQLERRM;
END;
$BODY$
LANGUAGE plpgsql VOLATILE;

---------------------------------------------------------------
-- Function INSERT_WOOD_CHIPS_EXCHANGER
---------------------------------------------------------------
CREATE OR REPLACE FUNCTION citydb_view.nrg8_insert_wood_chips_exchanger(
  id                     integer DEFAULT NULL,
  gmlid                  varchar(256) DEFAULT NULL,
  gmlid_codespace        varchar(1000) DEFAULT NULL,
  name                   varchar(1000) DEFAULT NULL,
...
--
  p_schema_name varchar := schema_name;
	class_name varchar DEFAULT 'WoodChipsExchanger'::varchar;
	db_prefix varchar DEFAULT 'nrg8';
	objectclass_id integer;
	inserted_id integer;
BEGIN
-- objectclass_classname_to_id could not find the WoodExchanger although in the objectclass table and GasExchanger worked
-- not ideal but had to move on so just hardcoded class id
objectclass_id=268; --citydb_pkg.objectclass_classname_to_id(class_name, db_prefix, p_schema_name);
...
PERFORM citydb_pkg.nrg8_insert_wood_chips_exchanger(
    id                      :=inserted_id,
    objectclass_id          :=objectclass_id,
    network_id              :=p_network_id,
    network_node_id         :=p_network_node_id,
...
RETURN inserted_id;
EXCEPTION
	WHEN OTHERS THEN RAISE NOTICE 'citydb_view.nrg8_insert_wood_chips_exchanger(): %', SQLERRM;
END;
$BODY$
LANGUAGE plpgsql VOLATILE;

---------------------------------------------------------------
-- Function INSERT_WOOD_LOGS_EXCHANGER
---------------------------------------------------------------
CREATE OR REPLACE FUNCTION citydb_view.nrg8_insert_wood_logs_exchanger(
  id                     integer DEFAULT NULL,
  gmlid                  varchar(256) DEFAULT NULL,
  gmlid_codespace        varchar(1000) DEFAULT NULL,
  name                   varchar(1000) DEFAULT NULL,
...
--
  p_schema_name varchar := schema_name;
	class_name varchar DEFAULT 'WoodLogsExchanger'::varchar;
	db_prefix varchar DEFAULT 'nrg8';
	objectclass_id integer;
	inserted_id integer;
BEGIN
-- objectclass_classname_to_id could not find the WoodExchanger although in the objectclass table and GasExchanger worked
-- not ideal but had to move on so just hardcoded class id
objectclass_id=269; --citydb_pkg.objectclass_classname_to_id(class_name, db_prefix, p_schema_name);
...
PERFORM citydb_pkg.nrg8_insert_wood_logs_exchanger(
    id                      :=inserted_id,
    objectclass_id          :=objectclass_id,
    network_id              :=p_network_id,
    network_node_id         :=p_network_node_id,
...
RETURN inserted_id;
EXCEPTION
	WHEN OTHERS THEN RAISE NOTICE 'citydb_view.nrg8_insert_wood_logs_exchanger(): %', SQLERRM;
END;
$BODY$
LANGUAGE plpgsql VOLATILE;
