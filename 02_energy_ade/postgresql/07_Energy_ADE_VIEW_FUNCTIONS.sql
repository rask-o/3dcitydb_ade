...
---------------------------------------------------------------
-- Function INSERT_WOOD_EXCHANGER
---------------------------------------------------------------
CREATE OR REPLACE FUNCTION citydb_view.nrg8_insert_wood_exchanger(
  id                     integer DEFAULT NULL,
  gmlid                  varchar(256) DEFAULT NULL,
  gmlid_codespace        varchar(1000) DEFAULT NULL,
  name                   varchar(1000) DEFAULT NULL,
...
--
  p_schema_name varchar := schema_name;
	class_name varchar DEFAULT 'WoodExchanger'::varchar;
	db_prefix varchar DEFAULT 'nrg8';
	objectclass_id integer;
	inserted_id integer;
BEGIN
...
PERFORM citydb_pkg.nrg8_insert_wood_exchanger(
    id                      :=inserted_id,
    objectclass_id          :=objectclass_id,
    network_id              :=p_network_id,
    network_node_id         :=p_network_node_id,
...
RETURN inserted_id;
EXCEPTION
	WHEN OTHERS THEN RAISE NOTICE 'citydb_view.nrg8_insert_wood_exchanger(): %', SQLERRM;
END;
$BODY$
LANGUAGE plpgsql VOLATILE;
