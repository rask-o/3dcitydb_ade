...
----------------------------------------------------------------
-- View CONV_SYSTEM_GAS_EXCHANGER
----------------------------------------------------------------
DROP VIEW IF EXISTS citydb_view.nrg8_conv_system_gas_exchanger CASCADE;
CREATE OR REPLACE VIEW citydb_view.nrg8_conv_system_gas_exchanger AS
SELECT
  co.id,
  co.objectclass_id,
  o.classname,
  ...
  he.network_id,
  he.network_node_id,
  he.prim_gas_supplier
FROM
  citydb.cityobject co,
  citydb.objectclass o,
  citydb.nrg8_conv_system cs,
  citydb.nrg8_gas_exchanger he
WHERE
  o.id = co.objectclass_id AND
  cs.id = co.id AND
  he.id = cs.id AND
  o.classname = 'GasExchanger';
--ALTER VIEW citydb_view.nrg8_conv_system_gas_exchanger OWNER TO postgres;

----------------------------------------------------------------
-- View CONV_SYSTEM_OIL_EXCHANGER
----------------------------------------------------------------
DROP VIEW IF EXISTS citydb_view.nrg8_conv_system_oil_exchanger CASCADE;
CREATE OR REPLACE VIEW citydb_view.nrg8_conv_system_oil_exchanger AS
SELECT
  co.id,
  co.objectclass_id,
  o.classname,
  ...
  he.network_id,
  he.network_node_id,
  he.prim_oil_supplier
FROM
  citydb.cityobject co,
  citydb.objectclass o,
  citydb.nrg8_conv_system cs,
  citydb.nrg8_oil_exchanger he
WHERE
  o.id = co.objectclass_id AND
  cs.id = co.id AND
  he.id = cs.id AND
  o.classname = 'OilExchanger';
...
---------------------------------------------------------------
-- View CONV_SYSTEM_HYDRAULIC_PUMP
----------------------------------------------------------------
DROP VIEW IF EXISTS citydb_view.nrg8_conv_system_hydraulic_pump CASCADE;
CREATE OR REPLACE VIEW citydb_view.nrg8_conv_system_hydraulic_pump AS
SELECT
  co.id,
  co.objectclass_id,
  o.classname,
...
FROM
  ...
  citydb.objectclass o,
  citydb.nrg8_conv_system cs,
  citydb.nrg8_hydraulic_pump ac
WHERE
  o.id = co.objectclass_id AND
  cs.id = co.id AND
  ac.id = cs.id AND
  o.classname = 'HydraulicPump';
--ALTER VIEW citydb_view.nrg8_conv_system_hydraulic_pump OWNER TO postgres;
