...
--
-- ***********************************************************************
-- ***************** Scenario_ADE_VIEW_FUNCTIONS.sql *****************
--
--
--
-- ***********************************************************************
...
---------------------------------------------------------------
-- Function SCN_DELETE_ADD_FEATURE
---------------------------------------------------------------
CREATE OR REPLACE FUNCTION citydb_view.scn2_delete_add_feature(
  IN id integer,
  IN schema_name varchar DEFAULT 'citydb'::varchar
)
RETURNS integer AS
...
RETURN deleted_id;
EXCEPTION
	WHEN OTHERS THEN RAISE NOTICE 'citydb_view.scn2_delete_add_feature (id: %): %', id, SQLERRM;
END;
$BODY$
LANGUAGE plpgsql VOLATILE;

---------------------------------------------------------------
-- Function SCN_DELETE_REMOVE_FEATURE
---------------------------------------------------------------
CREATE OR REPLACE FUNCTION citydb_view.scn2_delete_remove_feature(
  IN id integer,
  IN schema_name varchar DEFAULT 'citydb'::varchar
)
RETURNS integer AS
...
RETURN deleted_id;
EXCEPTION
	WHEN OTHERS THEN RAISE NOTICE 'citydb_view.scn2_delete_remove_feature (id: %): %', id, SQLERRM;
END;
$BODY$
LANGUAGE plpgsql VOLATILE;
...
-- Function SCN_DELETE_REMOVE_FEATURE
---------------------------------------------------------------
CREATE OR REPLACE FUNCTION citydb_view.scn2_delete_change_feature_attribute(
  IN id integer,
  IN schema_name varchar DEFAULT 'citydb'::varchar
)
RETURNS integer AS
...
RETURN deleted_id;
EXCEPTION
	WHEN OTHERS THEN RAISE NOTICE 'citydb_view.scn2_delete_change_feature_attribute (id: %): %', id, SQLERRM;
END;
$BODY$
LANGUAGE plpgsql VOLATILE;
