...
CREATE TABLE citydb.scn2_scenario (
  ...
  scenario_parent_id   integer,          -- This is a foreign key to citydb.scn2_scenario.id
  -- scenario_root_id     integer,          -- This is a foreign key to citydb.scn2_scenario.id
  gmlid           varchar,
...
CREATE INDEX scn2_scen_parent_id_fkx           ON citydb.scn2_scenario USING btree (scenario_parent_id);
-- CREATE INDEX scn2_scen_root_id_fkx             ON citydb.scn2_scenario USING btree (scenario_root_id);
...
-- COMMENT ON COLUMN citydb.scn2_scenario.scenario_root_id     IS 'ID of the root scenario';
...
CREATE INDEX scn2_oper_ctyobj_id_inx           ON citydb.scn2_operation USING btree (citydb_object_id);
...
COMMENT ON COLUMN citydb.scn2_operation.citydb_attrib_name    IS 'Name of the generic or dimensional attribute in the 3DCityDB';
...
COMMENT ON COLUMN citydb.scn2_operation.realval               IS 'Real (double precision) value';
...
COMMENT ON COLUMN citydb.scn2_scenario_parameter.realval          IS 'Real (double precision) value';
...
ALTER TABLE IF EXISTS citydb.scn2_scenario ADD CONSTRAINT scn2_scen_scn_scen_fk1 FOREIGN KEY (scenario_parent_id) REFERENCES citydb.scn2_scenario (id) MATCH FULL ON UPDATE CASCADE ON DELETE NO ACTION;
-- ALTER TABLE IF EXISTS citydb.scn2_scenario ADD CONSTRAINT scn2_scen_scn_scen_fk2 FOREIGN KEY (scenario_root_id) REFERENCES citydb.scn2_scenario (id) MATCH FULL ON UPDATE CASCADE ON DELETE NO ACTION;
...
-- UNIQUE KEY constraint on Table OPERATION
ALTER TABLE IF EXISTS citydb.scn2_operation ADD CONSTRAINT scn2_oper_gmlid_uq UNIQUE (gmlid);
